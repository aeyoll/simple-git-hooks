...
const VALID_GIT_HOOKS = [
    ...
    'p4-pre-submit',
    'post-index-change',
    'filter-flow-create-finish-version',
    'filter-flow-create-start-versions',
    ...
    'filter-flow-release-finish-versionok',
    ...
    'post-flow-create-finishting',
    'post-flow-create-startost',
    ...
    'pre-flow-create-finish',
    'pre-flow-create-startpost',
